...
void editBenchmarkConfig(String config_file) {
    withCredentials([string(credentialsId: 'benchmark-metrics-datastore-password', variable: 'DATASTORE_USER'),
                     string(credentialsId: 'benchmark-metrics-datastore-user', variable: 'DATASTORE_PASSWORD')]) {
